...
-- remotely as version 20260628030526). Verbatim from the remote migration
-- history. Superseded by 20260628030617; execute grants were later locked to
-- service_role by 20260702120000_audit_hardening.
...
as $function$
  select case
    when r.id is null or not r.loyalty_enabled then jsonb_build_object('enabled', false)
